...
class CouncilEditor extends React.Component {
    ...
    modules = {
        toolbar: [["bold", "italic", "underline", "strike", "blockquote"], [{ list: "ordered" }, { list: "bullet" }, { indent: "-1" }, { indent: "+1" }], ["image"]],
    };

    formats = ["header", "bold", "italic", "underline", "strike", "blockquote", "list", "bullet", "indent", "image"];
    ...
    render() {
        return (
            <>
                <h1 style={{ marginTop: "100px", marginLeft: "3%", marginBottom: "40px" }}>{this.path_id ? "공약 이행 인증 수정" : "공약 이행 인증 작성"}</h1>
                <input
